...
import { Framework, JsonSchemaFormService, WidgetLibraryModule, buildTitleMap, hasOwn, isArray, isDefined } from 'angular2-json-schema-form';
...
var IonicFrameworkComponent = (function () {
    ...
    function () {
        if (this.layoutNode) {
            ...
            if (!includes(['$ref', 'advancedfieldset', 'authfieldset', 'button', 'card',
...
export { IonicButtonComponent, IonicInputComponent, IonicCheckboxComponent, IonicFrameworkComponent, IonicTextareaComponent, IonicSelectComponent, IonicTabsComponent, IonicToggleComponent, IonicSectionComponent, IonicRootComponent, IonicFrameworkModule, IONIC_FRAMEWORK_COMPONENTS, IonicFramework };
